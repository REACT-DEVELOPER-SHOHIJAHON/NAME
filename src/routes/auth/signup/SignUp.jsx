    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg">
        ...
        <form className="space-y-6" onSubmit={handleRegister}>
          ...
          <p>Already have an account? <Link to="/auth/login" className="text-green-500 hover:text-yellow-700 transition duration-150 ease-in-out">Log In</Link></p>
            <button type="submit" disabled={isLoading} className="disabled:opacity-20 group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out">
